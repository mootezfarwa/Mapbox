...
const avoPlants = [
    { name: 'Tunisia', coordinates: [9.9097, 36.3756] },
...
function Map() {
    ...
    const fetchCompanies = async () => {
        try {
            ...
            // Extract company names from the fetched data only one time without redondance
            ...
            // Inside fetchCompanies function, extract regions from the fetched data without redondance
